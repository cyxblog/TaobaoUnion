...
public class ScrollingUtil {
    ...
    public static boolean isViewToBottom(View view, int mTouchSlop) {
        ...
        if (view instanceof TBNestedScrollView)
            return isNestedScrollViewToBottom((TBNestedScrollView) view);
        if (view instanceof ViewGroup) return isViewGroupToBottom((ViewGroup) view);
        return false;
    }

    private static boolean isNestedScrollViewToBottom(TBNestedScrollView view) {
        return view.isToBottom();
    }
