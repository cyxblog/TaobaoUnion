...
public class HomePagerContent implements Serializable {
    ...
    public static class DataDTO implements Serializable {
        ...
        public String toString() {
            return "DataDTO{" +
                    ...
                    ", couponClickUrl='" + coupon_click_url + '\'' +
                    ", couponEndTime='" + coupon_end_time + '\'' +
                    ", couponInfo=" + coupon_info +
                    ", couponRemainCount=" + coupon_remain_count +
                    ", couponShareUrl='" + coupon_share_url + '\'' +
                    ", couponStartFee='" + coupon_start_fee + '\'' +
                    ", couponStartTime='" + coupon_start_time + '\'' +
                    ", couponTotalCount=" + coupon_total_count +
        ...
        public static class SmallImagesDTO implements Serializable {
